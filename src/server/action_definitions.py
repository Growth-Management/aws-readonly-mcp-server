...
ACTION_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "get_s3_bucket_security": {
        ...
        "description": "Get public access, ACL, bucket policy, and encryption information for one S3 bucket.",
        "input_schema": _schema(
            {"bucket_name": {"type": "string", "description": "The S3 bucket name."}},
            ["bucket_name"],
        ),
    ...
    "get_s3_request_metrics": {
        ...
        "description": "Get S3 request metric availability and recent metric datapoints for one bucket.",
        "input_schema": _schema(
            {"bucket_name": {"type": "string", "description": "The S3 bucket name."}},
            ["bucket_name"],
        ),
    ...
    "get_s3_transfer_summary": {
        ...
        "description": "Get S3 transfer metric availability and recent metric datapoints for one bucket.",
        "input_schema": _schema(
            {"bucket_name": {"type": "string", "description": "The S3 bucket name."}},
            ["bucket_name"],
        ),
    ...
    "list_trusted_advisor_checks": {
        ...
        "input_schema": _schema(
            {"language": {"type": "string", "default": "ja", "description": "Trusted Advisor response language."}}
        ),
    },
}
